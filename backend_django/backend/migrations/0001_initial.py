    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_preference', models.CharField(choices=[('email', 'Email'), ('sms', 'SMS'), ('whatsapp', 'WhatsApp')], default='whatsapp', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='backend.doctor')),
            ],
            options={
